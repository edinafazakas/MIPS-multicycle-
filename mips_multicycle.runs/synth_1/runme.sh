...
HD_PWD='D:/MATERIALE AN 3 SEM 1/SSC/lab7/mips_multicycle/mips_multicycle.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiCycle.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiCycle.tcl
